...
TEST_F(RotateTest, Test7_LeftRotateRightChildHasLeftSubtree) 
{
	using Key = int;
	using Value = double;
	...
	NodeSeq<Key, Value> seq{
		...
		NodeValidation<Key, Value>{4, 4.0, 0, true, false},
		NodeValidation<Key, Value>{2, 2.0, 0, false, true},
		NodeValidation<Key, Value>{3, 3.0, 0, false, false},
	};
